...
# Level up character sheet
    ...
    async def on_raw_reaction_add(self, payload):
        ...
        if reaction == "\U0001F514": # Bell emoji - :bell: 
            ...
            if str(user_reaction_msg_id) in str(embed_ids): # In this case the reaction is given to a message in BuyStockMsgID
                ...
                embed_channel_id = self.charactersheet[member_id]['Character Sheet Channel ID']
                channel = guild.get_channel(embed_channel_id)
                message_id = self.charactersheet[member_id]['Character Sheet Embed ID']
                user_msg = await channel.fetch_message(message_id) 

                cs_embed = discord.Embed(title=f"**{self.charactersheet[member_id]['Character']}'s character sheet**", description=f"*React with :bell: to level up*", color=0x303136)
                cs_embed.add_field(name="**Level**", value=f"{self.charactersheet[member_id]['Character Sheet']['Level']}")
                cs_embed.add_field(name="**\u200b**", value=f"__**Kompetencer**__", inline=False)
                cs_embed.add_field(name="**Styrke**", value=f"{self.charactersheet[member_id]['Character Sheet']['Styrke']}", inline=True)
                cs_embed.add_field(name="**Udholdenhed**", value=f"{self.charactersheet[member_id]['Character Sheet']['Udholdenhed']}")
                cs_embed.add_field(name="**Intelligens**", value=f"{self.charactersheet[member_id]['Character Sheet']['Intelligens']}")
                cs_embed.add_field(name="**Finesse**", value=f"{self.charactersheet[member_id]['Character Sheet']['Finesse']}")
                cs_embed.add_field(name="**Perception**", value=f"{self.charactersheet[member_id]['Character Sheet']['Perception']}")
                cs_embed.add_field(name="**Karisma**", value=f"{self.charactersheet[member_id]['Character Sheet']['Karisma']}")
                cs_embed.add_field(name="**Initiativ**", value=f"{self.charactersheet[member_id]['Character Sheet']['Initiativ']}\n \n__**Kamp Evner**__", inline=False)

                cs_embed.add_field(name="**Nærkamp**", value=f"{self.charactersheet[member_id]['Character Sheet']['Nærkamp']} *(+{self.charactersheet[member_id]['Character Sheet']['Nærkamp_Bonus']})*", inline=True)
                cs_embed.add_field(name="**Kaste/Strenge Våben**", value=f"{self.charactersheet[member_id]['Character Sheet']['Kaste_Strenge_våben']} *(+{self.charactersheet[member_id]['Character Sheet']['Kaste_Strenge_våben_Bonus']})*")
                cs_embed.add_field(name="**Skydevåben**", value=f"{self.charactersheet[member_id]['Character Sheet']['Skydevåben']} *(+{self.charactersheet[member_id]['Character Sheet']['Skydevåben_Bonus']})*")
                cs_embed.add_field(name="**Snig**", value=f"{self.charactersheet[member_id]['Character Sheet']['Snig']} *(+{self.charactersheet[member_id]['Character Sheet']['Snig_Bonus']})*\n \n__**Sociale Evner**__", inline=False)

                cs_embed.add_field(name="**Smigre**", value=f"{self.charactersheet[member_id]['Character Sheet']['Smigre']} *(+{self.charactersheet[member_id]['Character Sheet']['Smigre_Bonus']})*", inline=True)
                cs_embed.add_field(name="**Løgn**", value=f"{self.charactersheet[member_id]['Character Sheet']['Løgn']} *(+{self.charactersheet[member_id]['Character Sheet']['Løgn_Bonus']})*")
                cs_embed.add_field(name="**Intimiderer**", value=f"{self.charactersheet[member_id]['Character Sheet']['Intimiderer']} *(+{self.charactersheet[member_id]['Character Sheet']['Intimiderer_Bonus']})*")
                cs_embed.add_field(name="**Handel**", value=f"{self.charactersheet[member_id]['Character Sheet']['Handel']} *(+{self.charactersheet[member_id]['Character Sheet']['Handel_Bonus']})*\n \n__**Håndværks Evner**__", inline=False)

                cs_embed.add_field(name="**Reparation**", value=f"{self.charactersheet[member_id]['Character Sheet']['Reparation']} *(+{self.charactersheet[member_id]['Character Sheet']['Reparation_Bonus']})*", inline=True)
                cs_embed.add_field(name="**Fælder**", value=f"{self.charactersheet[member_id]['Character Sheet']['Fælder']} *(+{self.charactersheet[member_id]['Character Sheet']['Fælder_Bonus']})*")
                cs_embed.add_field(name="**Overlevelse**", value=f"{self.charactersheet[member_id]['Character Sheet']['Overlevelse']} *(+{self.charactersheet[member_id]['Character Sheet']['Overlevelse_Bonus']})*")
                cs_embed.add_field(name="**Håndarbejde**", value=f"{self.charactersheet[member_id]['Character Sheet']['Håndarbejde']} *(+{self.charactersheet[member_id]['Character Sheet']['Håndarbejde_Bonus']})*\n \n__**Esoteriske Evner**__", inline=False)

                cs_embed.add_field(name="**Videnskab**", value=f"{self.charactersheet[member_id]['Character Sheet']['Videnskab']} *(+{self.charactersheet[member_id]['Character Sheet']['Videnskab_Bonus']})*", inline=True)
                cs_embed.add_field(name="**Alkymi**", value=f"{self.charactersheet[member_id]['Character Sheet']['Alkymi']} *(+{self.charactersheet[member_id]['Character Sheet']['Alkymi_Bonus']})*")
                cs_embed.add_field(name="**Lægevidenskab**", value=f"{self.charactersheet[member_id]['Character Sheet']['Lægevidenskab']} *(+{self.charactersheet[member_id]['Character Sheet']['Lægevidenskab_Bonus']})*")
                cs_embed.add_field(name="**Historie**", value=f"{self.charactersheet[member_id]['Character Sheet']['Historie']} *(+{self.charactersheet[member_id]['Character Sheet']['Historie_Bonus']})*")


                current_level = int(self.charactersheet[member_id]['Character Sheet']['Level'])
                level_up = 1
                ...
                self.charactersheet[member_id]['Character Sheet']['Level'] = current_level
    ...
    # UPGRADE EVNER
                ...
                current_evner = int(self.charactersheet[member_id]['Character Sheet'][data_evner])
                evner_level_up = 5
                ...
                cs_embed.set_field_at(evner_index, name=evner, value=f"{current_evner} *(+{self.charactersheet[member_id]['Character Sheet'][item_stat_bonus]})*")

                self.charactersheet[member_id]['Character Sheet'][data_evner] = current_evner
                fh.save_file(self.charactersheet, 'charactersheet')
    ...
    # HITTING A LEVEL DIVISBLE BY 5
                if current_level % 5 == 0:
                    ...
                    current_kompetence = int(self.charactersheet[member_id]['Character Sheet'][data_kompetence])
                    ...
                    self.charactersheet[member_id]['Character Sheet'][data_kompetence] = current_kompetence
                    fh.save_file(self.charactersheet, 'charactersheet')
